...
public class BuildCompleteRepositoryViewModel
{
  [Required(ErrorMessage = "O identificador do repositório é obrigatório.")]
  [JsonPropertyName("id")]
  ...
  [Url(ErrorMessage = "A URL do repositório não é válida.")]
